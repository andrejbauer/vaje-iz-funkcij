...
\draw [color=cqcqcq,, xstep=2.0cm,ystep=2.0cm] (-2.5,-5.4809580487804945) grid (3.9,11.145504390243905);
\draw[->,color=black] (-2.5,0.) -- (3.9,0.);
\foreach \x in {-2.,2.}
\draw[shift={(\x,0)},color=black] (0pt,2pt) -- (0pt,-2pt) node[below] {\footnotesize $\x$};
\draw[->,color=black] (0.,-5.4809580487804945) -- (0.,11.145504390243905);
\foreach \y in {-4.,-2.,2.,4.,6.,8.,10.}
\draw[shift={(0,\y)},color=black] (2pt,0pt) -- (-2pt,0pt) node[left] {\footnotesize $\y$};
\draw[color=black] (0pt,-10pt) node[right] {\footnotesize $0$};
\clip(-2.5,-5.4809580487804945) rectangle (3.9,11.145504390243905);
\draw[line width=2.pt,color=qqqqff,smooth,samples=100,domain=-2.5:3.9] plot(\x,{(\x)^(3.0)-2.0*(\x)^(2.0)-4.0*(\x)+8.0});
\begin{scriptsize}
\draw[color=qqqqff] (-2.5213912195122,-2.9812751219512266) node {p(x)};
\draw [fill=ffqqqq] (0.,8.) circle (2.0pt);
\draw[color=ffqqqq] (1.4781014634146334,8.474414634146342) node {začetna vrednost};
\draw [fill=ffqqff] (-0.6666666666666666,9.481481481481481) circle (2.0pt);
\draw[color=ffqqff] (-1.2929756097561014,9.874237073170733) node {maksimum};
\draw [fill=qqzzqq] (2.,0.) circle (2.0pt);
\draw[color=qqzzqq] (3.763525853658537,0.4182936585365806) node {ničla in minimum};
\draw [fill=qqzzqq] (-2.,0.) circle (2.0pt);
\draw[color=qqzzqq] (-1.464382439024394,0.4754292682926782) node {ničla};
\draw [fill=uuuuuu] (2.,0.) circle (2.0pt);
\draw [fill=yqqqyq] (1.,3.) circle (2.0pt);
\draw[color=yqqqyq] (1.449533658536583,3.475048780487802) node {p(1)};
\draw [fill=yqqqyq] (-1.,9.) circle (2.0pt);
\draw[color=yqqqyq] (-1.6072214634146382,9.21717756097561) node {p(-1)};
\end{scriptsize}
\end{tikzpicture}
