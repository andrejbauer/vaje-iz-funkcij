...
\draw[->,color=black] (-9.41461886825452,0.) -- (6.3757608150673954,0.);
\foreach \x in {-8.,-6.,-4.,-2.,2.,4.,6.}
\draw[shift={(\x,0)},color=black] (0pt,2pt) -- (0pt,-2pt) node[below] {\footnotesize $\x$};
\draw[->,color=black] (0.,-4.083843134036176) -- (0.,8.092541199229634);
\foreach \y in {-4.,-2.,2.,4.,6.,8.}
\draw[shift={(0,\y)},color=black] (2pt,0pt) -- (-2pt,0pt) node[left] {\footnotesize $\y$};
\draw[color=black] (0pt,-10pt) node[right] {\footnotesize $0$};
\clip(-9.41461886825452,-4.083843134036176) rectangle (6.3757608150673954,8.092541199229634);
\draw[line width=2.pt,color=qqwuqq,smooth,samples=100,domain=-9.41461886825452:6.3757608150673954] plot(\x,{2.0^((\x))});
\draw[line width=2.pt,color=ccqqqq,smooth,samples=100,domain=-9.41461886825452:6.3757608150673954] plot(\x,{2.0^((\x)+1.0)-3.0});
\draw [line width=1.2pt,dash pattern=on 3pt off 3pt,color=qqccqq] (0.,1.)-- (-1.,1.)-- (-1.,-2.);
\draw [line width=2.pt,dash pattern=on 3pt off 3pt,color=aqaqaq] (1.,2.)-- (0.,2.)-- (0.,-1.);
\draw [line width=1.2pt,dash pattern=on 3pt off 3pt,color=yqyqyq,domain=-9.41461886825452:6.3757608150673954] plot(\x,{(-3.-0.*\x)/1.});
\begin{scriptsize}
\draw[color=qqwuqq] (-7.023821944371272,0.5726508746899044) node {y'};
\draw [fill=qqccqq] (0.,1.) circle (2.0pt);
\draw [fill=yqyqyq] (1.,2.) circle (2.0pt);
\draw[color=ccqqqq] (-7.135021801296074,-2.401945298048547) node {f(x)};
\draw [fill=qqccqq] (-1.,-2.) circle (2.0pt);
\draw [fill=yqyqyq] (0.,-1.) circle (2.0pt);
\draw[color=yqyqyq] (-6.690222373596865,-3.2915441534469623) node {$y = -3$};
\end{scriptsize}
\end{tikzpicture}
%
\end{zgled}
...
\definecolor{qqwuqq}{rgb}{0.,0.39215686274509803,0.}
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm,scale=0.6]
\draw[->,color=black] (-5.962049588774973,0.) -- (7.514070837014174,0.);
\foreach \x in {-5.,-4.,-3.,-2.,-1.,1.,2.,3.,4.,5.,6.,7.}
\draw[shift={(\x,0)},color=black] (0pt,2pt) -- (0pt,-2pt) node[below] {\footnotesize $\x$};
\draw[->,color=black] (0.,-2.9464833868943394) -- (0.,7.6876060552437275);
\foreach \y in {-2.,-1.,1.,2.,3.,4.,5.,6.,7.}
\draw[shift={(0,\y)},color=black] (2pt,0pt) -- (-2pt,0pt) node[left] {\footnotesize $\y$};
\draw[color=black] (0pt,-10pt) node[right] {\footnotesize $0$};
\clip(-5.962049588774973,-2.9464833868943394) rectangle (7.514070837014174,7.6876060552437275);
\draw[line width=2.pt,color=qqwuqq,smooth,samples=100,domain=-6.394698325375187:4.496895020831907] plot(\x,{3.0^((\x))});
\draw[line width=2.pt,color=ccqqqq,smooth,samples=100,domain=-5.962049588774973:7.514070837014174] plot(\x,{1.0-(\x)});
\begin{scriptsize}
\draw[color=qqwuqq] (-4.36223082314358,0.2813862402325262) node {$f$};
\draw[color=ccqqqq] (-4.983336932153415,5.476091879223865) node {$g$};
\draw [fill=uuuuuu] (3.2449442555913735E-9,0.9999999967550558) circle (2.0pt);
\end{scriptsize}
\end{tikzpicture}
